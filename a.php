...
<body>
    ...
    <div class="main w3-container">
        ...
        <div class="w3-container w3-padding-64" id="users">
            ...
            <table class="w3-table w3-bordered w3-striped w3-border w3-hoverable w3-white">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='editUser.php?id=" . htmlspecialchars($row['user_id']) . "' class='w3-button w3-blue w3-small'>Edit</a>
                                <a href='deleteUser.php?id=" . htmlspecialchars($row['user_id']) . "' class='w3-button w3-red w3-small'>Delete</a>
                              </td>";
                        echo "</tr>";
                    }
                } else {
            ...
            <a class="w3-button w3-black" style="margin:8px 0  8px 0" href="updateAdmin.php">Edit Admin</a>
        </div>
