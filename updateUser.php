...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE Users SET first_name=?, last_name=?, username=?, password_hash=?, email=?, phone_number=? WHERE id=?";

    if ($stmt = $mysqli->prepare($sql)) {
        $stmt->bind_param("ssssssi", $param_fname, $param_lname, $param_username, $param_password, $param_email, $param_mobile, $param_user_id);
...
<body>
    ...
    <div class="w3-content w3-container w3-padding-64" id="contact">
        ...
        <p class="w3-center"><em>update user</em></p>
